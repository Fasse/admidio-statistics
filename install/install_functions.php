...
function statAddMenu() {
    ...
    $sql = 'INSERT INTO '.TBL_MENU.'
            ...
            VALUES (NULL, 3, 0, 100, 1, \'statistics\', \''.FOLDER_PLUGINS.'/statistics/gui/overview.php\', \'lists.png\', \'PLG_STATISTICS_STATISTICS\', \'PLG_STATISTICS_STATISTICS_DESC\')
                 , (NULL, 3, 0, 101, 1, \'statistics_editor\', \''.FOLDER_PLUGINS.'/statistics/gui/editor.php\', \'options.png\', \'PLG_STATISTICS_STATISTICS_EDITOR\', \'PLG_STATISTICS_STATISTICS_EDITOR_DESC\')';
    $gDb->query($sql);
